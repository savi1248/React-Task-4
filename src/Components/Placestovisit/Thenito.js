    ...
    return (
        <section className=" ">
            ...
            <div className=' d-flex '>
                <div >
                    <img src={Theni1} alt=" " style={{ height: '225px', width: '200px' }} />
                </div>
                <div className='  ms-3  mt-2 '>
                    <h6 className=' fw-bold '> Chinna Suruli Falls, Overview</h6>

                    <p>
                        Located in the lap of wild, green forests, Chinna Suruli Falls is a picturesque destination to visit from Thenil. It cascades all the way down from Meghamalai to form a pool of cool, sparkling water at the foothills of the mountain. Located around 54 kilometres away from the main centre near the Kombaithozhu village, Chinna Suruli Falls is a lovely and serene destination to visit in and around Theni. It can be included in your itinerary of local sightseeing if you are visiting Theni and its nearby attractions,
                    </p>
                    <p>
            ...
            <div className=' d-flex  mt-5 '>
                ...
                <div className='  me-3 mt-2  '>
                    <h6 className=' fw-bold '> Kumbakkarai Falls, Overview</h6>
                    ...
                    <p>
                        Besides boasting of immense scenic beauty and the melodious tinkering of the gushing waters, the place also offers utter peace and tranquility. Also unlike most other waterfalls, Kumbakkarai Falls also offer shallow waters where tounsts are welcomed to swim or to take a dip. The popular tourist spot is the most crowded during the rainy season when the water level is high and the neighboring areas glows with greenery,
                    </p>
                </div>
                <div className=' '>
                    <img src={Theni2} alt=" " style={{ height: '222px', width: '200px' }} />
                </div>
            ...
            <div className=' d-flex  mt-5'>
                <div >
                    <img src={Theni3} alt=" " style={{ height: '225px', width: '200px' }} />
                </div>
                <div className='  ms-3  mt-2 '>
                    <h6 className=' fw-bold '> Meghamalai, Overview</h6>
            ...
            <div className=' d-flex  mt-5 '>
                ...
                <div className='  me-3  mt-2 '>
                    <h6 className=' fw-bold '> Suruli Falls, Overview</h6>
                ...
                <div >
                    <img src={Theni4} alt=" " style={{ height: '220px', width: '200px' }} />
                </div>
