    ...
    return (
        <section className=" ">
            ...
            <div className=' d-flex '>
                <div >
                    <img src={Rameswaram1} alt=" " style={{ height: '230px', width: '200px' }} />
                </div>
                <div className='  ms-3  mt-2 '>
                    <h6 className=' fw-bold '> Dhanushkodi Temple, Overview</h6>
            ...
            <div className=' d-flex  mt-5 '>
                ...
                <div className='  me-3 mt-2  '>
                    <h6 className=' fw-bold '> Lakshmana Temple, Overview</h6>

                    <p>
                        Lakshmana Tirtham had been constructed in the loving memory of Lord Lakshman, brother of Lord Rama. In order to offer sacred prayers to lord Lakshmana, this temple has been constructed in Rameshwaram itself which indicates that Lord Lakshman had been given a valuable place in the dynasty of Lord Rama.</p>

                    <p>
                        Several wonderful sculptures of Lord Lakshmana have been carved out from marble and the temple has the statues of lord Rama and Goddess Sita too which signifies the spirit of unitedness that exisited between them.                      </p>
                </div>
                <div className=' '>
                    <img src={Rameswaram2} alt=" " style={{ height: '190px', width: '200px' }} />
                </div>
            ...
            <div className=' d-flex  mt-5'>
                <div >
                    <img src={Rameswaram3} alt=" " style={{ height: '248px', width: '200px' }} />
                </div>
                <div className='  ms-3 mt-2  '>
                    <h6 className=' fw-bold '> Villoondi Tirtham, Overview</h6>
            ...
            <div className=' d-flex  mt-5 '>
                ...
                <div className='  me-3  mt-2 '>
                    <h6 className=' fw-bold '> Rameshwaram Temple, Overview</h6>
                ...
                <div >
                    <img src={Rameswaram4} alt=" " style={{ height: '220px', width: '200px' }} />
                </div>
