    ...
    return (
        <section className=" ">
            ...
            <div className=' d-flex '>
                <div >
                    <img src={Kumbakonam1} alt=" " style={{ height: '210px', width: '200px' }} />
                </div>
                <div className='  ms-3 mt-2  '>
                    <h6 className=' fw-bold '>
                        Sarangapani Temple, Overview </h6>
            ...
            <div className=' d-flex  mt-5 '>
                ...
                <div className='  me-3  mt-2 '>
                    <h6 className=' fw-bold '>Nageswaran Temple, Overview</h6>
                ...
                <div className=' '>
                    <img src={Kumbakonam2} alt=" " style={{ height: '220px', width: '200px' }} />
                </div>
            ...
            <div className=' d-flex  mt-5'>
                <div >
                    <img src={Kumbakonam3} alt=" " style={{ height: '229px', width: '200px' }} />
                </div>
                <div className='  ms-3  mt-2 '>
                    <h6 className=' fw-bold '> Adi Kumbeshwara Temple, Overview</h6>

                    <p>
                        Believed to have been constructed in the 7th century AD by the Cholas, Adi Kumbestwara Temple is one of the grandest and the oldest Shiva temple in the town. The temple has a magnificent architecture with the trademark style of the Cholas. It is dedicated to Lord Shiva and houses a unique Shiva lingam.
                    </p>
                    <p>
                        The temple complex covers an area of 30,181 sq ft (2,803.9 m2) and houses four gateway towers known as gopurams. The tallest is the easter tower, with 11 stones and a height of 128 feet (39 m) The temple has numerous shrines with those of Kumbeswarar and Mangalambigai Amman being the most prominent. The temple complex houses many halls, the most notable is the sixteen-pillared hall built during the Vijayanagara period that has all the 27 stars and 12 zodiacs sculpted in a single stone.
                    </p>
                </div>
            </div>
...
export default KumbakonamPlace