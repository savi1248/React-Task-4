    ...
    return (
        <section className=" ">
            ...
            <div className=' d-flex '>
                <div >
                    <img src={Kanyakumari1} alt=" " style={{ height: '205px', width: '200px' }} />
                </div>
            ...
            <div className=' d-flex  mt-5 '>
                ...
                <div className=' '>
                    <img src={Kanyakumari2} alt=" " style={{ height: '220px', width: '200px' }} />
                </div>
            ...
            <div className=' d-flex  mt-5'>
                <div >
                    <img src={Kanyakumari3} alt=" " style={{ height: '245px', width: '200px' }} />
                </div>
                <div className='  ms-3   mt-2'>
            ...
            <div className=' d-flex  mt-5 '>
                ...
                <div >
                    <img src={Kanyakumari4} alt=" " style={{ height: '200px', width: '200px' }} />
                </div>
