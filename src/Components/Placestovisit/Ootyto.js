    ...
    return (
        <section className=" ">
            ...
            <div className=' d-flex '>
                <div >
                    <img src={Ooty1} alt=" " style={{ height: '210px', width: '200px' }} />
                </div>
            ...
            <div className=' d-flex  mt-5 '>
                ...
                <div className=' '>
                    <img src={Ooty2} alt=" " style={{ height: '205px', width: '200px' }} />
                </div>
            ...
            <div className=' d-flex  mt-5'>
                <div >
                    <img src={Ooty3} alt=" " style={{ height: '205px', width: '200px' }} />
                </div>
                <div className='  ms-3  mt-2 '>
            ...
            <div className=' d-flex  mt-5 '>
                ...
                <div >
                    <img src={Ooty4} alt=" " style={{ height: '200px', width: '200px' }} />
                </div>
