      ...
      <Row >
        <Col md={3}>
          <Card>
            ...
            <Card.Body>
              <Card.Title className='fw-bold'>Theerthamalai Temple</Card.Title>
              <Card.Text>
        ...
        <Col md={3}>
          <Card>
            ...
            <Card.Body>
              <Card.Title className='fw-bold'>Hogenakkal Falls</Card.Title>
              <Card.Text>
        ...
        <Col md={3}>
          <Card>
            ...
            <Card.Body>
              <Card.Title className='fw-bold'>Pennagram Village</Card.Title>
              <Card.Text>
        ...
        <Col md={3}>
          <Card>
            ...
            <Card.Body>
              <Card.Title className='fw-bold'>Mettur Dam</Card.Title>
              <Card.Text>
