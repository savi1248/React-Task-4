    ...
    return (
        <section className=" mg-5">
            ...
            <div className=' d-flex '>
                <div >
                    <img src={Hogenakkal1} alt=" " style={{ height: '250px', width: '200px' }} />
                </div>
            ...
            <div className=' d-flex  mt-5 '>
                ...
                <div className=' '>
                    <img src={Hogenakkal2} alt=" " style={{ height: '228px', width: '200px' }} />
                </div>
            ...
            <div className=' d-flex  mt-5'>
                <div >
                    <img src={Hogenakkal3} alt=" " style={{ height: '230px', width: '200px' }} />
                </div>
                <div className='  ms-3  mt-2 '>
            ...
            <div className=' d-flex  mt-5 '>
                ...
                <div >
                    <img src={Hogenakkal4} alt=" " style={{ height: '230px', width: '200px' }} />
                </div>
