    ...
    return (
        <section className=" mg-5">
            ...
            <div className=' d-flex '>
                <div >
                    <img src={Madurai1} alt=" " style={{ height: '248px', width: '200px' }} />
                </div>
                <div className='  ms-3  mt-2 '>
                    <h6 className=' fw-bold '>
                        Vaigai Dam, Overview</h6>
            ...
            <div className=' d-flex  mt-5 '>
                ...
                <div className=' '>
                    <img src={Madurai2} alt=" " style={{ height: '220px', width: '200px' }} />
                </div>
            ...
            <div className=' d-flex  mt-5'>
                <div >
                    <img src={Madurai3} alt=" " style={{ height: '247px', width: '200px' }} />
                </div>
                <div className='  ms-3  mt-2 '>
                    <h6 className=' fw-bold '> Samanar Hills, Overview</h6>
            ...
            <div className=' d-flex  mt-5 '>
                ...
                <div className='  me-3  mt-2 '>
                    <h6 className=' fw-bold '> Thirumalai Nayakar, Overview</h6>
                ...
                <div >
                    <img src={Madurai4} alt=" " style={{ height: '220px', width: '200px' }} />
                </div>
